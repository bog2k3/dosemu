import * as bbox from "./dosemu-bbox.mjs";
import { BoundingBox } from "./dosemu-bbox.mjs";
...
export function computeBoundingBox(sprite) {
	...
	sprite.bbox = {
		left: minX - sprite.originX,
		right: maxX - sprite.originX,
		up: minY - sprite.originY,
		down: maxY - sprite.originY
	};
}
